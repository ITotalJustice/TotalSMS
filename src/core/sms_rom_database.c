...
/* -----------------------------------------------------*/
    ...
    { .crc = 0x25EB9F80, .rom = 0x08000, .ram = 0x0000, .map = MAPPER_TYPE_NONE, .sys = SMS_System_SMS },
    // Bomber Raid (UE) [!].sms
    ...
    { .crc = 0x89B79E77, .rom = 0x6C000, .ram = 0x0000, .map = MAPPER_TYPE_KOREAN, .sys = SMS_System_SMS },
    ...
    // Dr. HELLO (K).sms
    { .crc = 0x16537865, .rom = 0x8000, .ram = 0x0000, .map = MAPPER_TYPE_NONE, .sys = SMS_System_SMS },
    ...
    // Sangokushi 3 (K).sms
    { .crc = 0x97D03541, .rom = 0x100000, .ram = 0x0000, .map = MAPPER_TYPE_KOREAN, .sys = SMS_System_SMS },
    // Satellite 7 (J) [!].sms
    ...
    { .crc = 0x8640E7E8, .rom = 0x8000, .ram = 0x0000, .map = MAPPER_TYPE_KOREAN, .sys = SMS_System_SMS },
    // Thunder Blade (J) [!].sms
    ...
    // Toto World 3 (K) [!].sms
    { .crc = 0x4F8D75EC, .rom = 0x40000, .ram = 0x0000, .map = MAPPER_TYPE_KOREAN, .sys = SMS_System_SMS },
    // Astro Flash (J) [!].sms
...
/* --------------------------------------------------------------------------------------------------------- */
    ...
    { .crc = 0x26D2862C, .rom = 0x8000, .ram = 0x0000, .map = MAPPER_TYPE_NONE, .sys = SMS_System_SG1000 },
    // Flipper (Taiwan).sg
